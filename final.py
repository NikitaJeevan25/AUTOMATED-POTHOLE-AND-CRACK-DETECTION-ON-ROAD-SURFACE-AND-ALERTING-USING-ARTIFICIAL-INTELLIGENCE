...
####    file_name = f.name
##    #server.add_attachment(file_data, maintype = 'image', subtype = file_type, filename = file_name)
##    img = cv2.imread('D:/OIL SPILL/capture.jpg')
##    server = smtplib.SMTP("smtp.gmail.com",587)
##    server.starttls()
##    server.login("techgalwin.tamil26@gmail.com","iyjmxuyrtlvnqysu")
##    server.sendmail("techgalwin.tamil26@gmail.com","mariyaaroni09.gsm@gmail.com","OIL SPILL DETECTED",img)
##    print('success')
...
msg = EmailMessage()
msg['Subject'] = "road potholes"
msg['From'] = "techgalwin.tamil26@gmail.com"
msg['To'] = "nikitajeevan111@gmail.com"
msg.set_content("ROAD POTHOLS DETECTED....")
def email():
    with open('capture.jpg','rb')as f:
        file_data = f.read()
        file_type = imghdr.what(f.name)
